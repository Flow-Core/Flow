...
class PackageMapperTest {
    ...
    void test_empty_input_should_return_empty_map() {
        Map<String, PackageWrapper> packages = PackageMapper.map(List.of());
    ...
    void test_single_file_with_no_package_should_go_to_empty_path() {
        ...
        Map<String, PackageWrapper> packages = PackageMapper.map(List.of(block));
    ...
    void test_multiple_files_same_package_should_group_together() {
        ...
        Map<String, PackageWrapper> packages = PackageMapper.map(List.of(block1, block2));
